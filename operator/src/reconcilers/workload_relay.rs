...
use crate::reconcilers::workload_graphql::WorkloadGraphqlComponent;
            ...
            .store_put(
                ...
                BTreeMap::from([(
                    ...
                    serde_json::to_string(&ech_board_common::RelayConfig {
                        ...
                        graphql_url: format!(
                            "http://{}:{}/graphql",
                            WorkloadGraphqlComponent.name(&owner),
                            network.spec.indexer.graphql.port
                        ),
                    })
                    .map_err(|e| {
                        crate::error::OperatorError::ControllerFatal(format!(
